...
// Image mappings (High quality Unsplash images)
...
`;
        ...
        // Write Markdown file
        fs.writeFileSync(path.join(CONTENT_DIR, `${filename}.md`), fileContent);
        console.log(`Generated ${filename}.md`);

        // Download Image
        try {
            await downloadImage(imageUrl, path.join(PUBLIC_DIR, imageName));
